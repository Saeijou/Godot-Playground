...
var data = ApplicationCommand.new()\
	super.set_name("autocomplete")\
	super.set_description("An example command with autocomplete")\
	super.add_option(ApplicationCommand.string_option("text", "Type some text to get autocomplete hints.", {
		"required": true,
		"autocomplete": true
	}))
