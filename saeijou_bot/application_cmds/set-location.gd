...
var data = ApplicationCommand.new()\
	super.set_name("set-location")\
	super.set_description("Example of choices for string option. Sets your location.")\
	super.add_option(ApplicationCommand.string_option("continent", "The name of the continent", {
		"required": true,
