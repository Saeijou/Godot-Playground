...
var type: String = 'rich': get = get_type, set = set_type
var description: String: get = get_description, set = set_description
var url: String: get = get_url, set = set_url
var timestamp: String: get = get_timestamp, set = set_timestamp
var color : get = get_color, set = set_color
