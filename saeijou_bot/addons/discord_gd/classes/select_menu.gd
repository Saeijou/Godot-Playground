...
var custom_id: String: get = get_custom_id, set = set_custom_id
var placeholder: String: get = get_placeholder, set = set_placeholder
var options: Array: get = get_options, set = set_options

var min_values = 1: get = get_min_values, set = set_min_values
var max_values = 1: get = get_max_values, set = set_max_values

var disabled: bool = false: get = get_disabled, set = set_disabled
